				...
				<#--<span>-->
					<#--<div class="control-group">-->
                        ...
                        <#--<div class="bui-form-group controls" data-rules="{dateRange : true}">-->
                            <#--<input name="start" type="text" class="calendar" id="startTime"/> --->
                            <#--<input name="end" type="text" class="calendar" id="endTime"/>-->
                        <#--</div>-->
                    <#--</div>-->
		           	<#--<div class="control-group">-->
                        <#--<label class="control-label">订单网址：</label>-->
                        <#--<div class="controls">-->
                            <#--<input name="website" id="url" type="text" class="input-large">-->
                        <#--</div>-->
                    <#--</div>-->
			       	<#--<div class="control-group">-->
            ...
            <form id="search-form">
					<span>
						<div class="control-group">
                            <label class="control-label">日期范围：</label>
                            <div class="bui-form-group controls" data-rules="{dateRange : true}">
                                <input name="start" type="text" class="calendar" id="startTime"/> - <input name="end" type="text" class="calendar" id="endTime"/>
                            </div>
                        </div>
			           	<div class="control-group">
                            <label class="control-label">订单网址：</label>
