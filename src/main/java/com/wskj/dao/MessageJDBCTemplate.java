...
public class MessageJDBCTemplate {
    ...
    public void createMessage(int userId,String messageContent,int messageType){
        ...
        jdbcTemplateObject.update(sql,userId,messageType,messageContent,new Timestamp(System.currentTimeMillis()));
    ...
    public void createMessage(int userId,String message_Content,int messageType,int messageGroupId,String messageFrom,int messageFromId){
        ...
        jdbcTemplateObject.update(sql,userId,messageType,message_Content,new Timestamp(System.currentTimeMillis()),messageGroupId,messageFrom,messageFromId);
    ...
    public int notifyMessage(int userId){
        ...
        return jdbcTemplateObject.query(sql,new Object[]{userId},new ResultSetExtractor<Integer>() {
            @Override
    ...
    public List<Message> getRencentMessage(int userId,int num){
        ...
        List<Message> messages = jdbcTemplateObject.query(sql,new Object[]{userId,num},new MessageMapper());
        return messages;
    }
    ...
    public void setResult(int messageId,int result){
        ...
        jdbcTemplateObject.update(sql,result,messageId);
    }
    ...
    public Message getMessage(int messageId){
        ...
        return jdbcTemplateObject.queryForObject(sql,new Object[]{messageId},new MessageMapper());
    }
}
