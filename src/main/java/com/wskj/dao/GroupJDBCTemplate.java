...
public class GroupJDBCTemplate {
    ...
    public Group getGroup(Integer groupId){
        ...
        Group group = jdbcTemplateObject.queryForObject(sql,new Object[]{groupId},new GroupMapper());
        return group;
    }
    ...
    public String getGroupName(Integer groupId){
        ...
        return jdbcTemplateObject.queryForObject(sql,new Object[]{groupId},String.class);
    }

    public Group getGroup(String groupName){
        String sql = "select * from ods.group where group_name = ?";
        try {
            Group group = jdbcTemplateObject.queryForObject(sql,
    ...
    public Integer getGroupId(String groupName){
        ...
        return jdbcTemplateObject.queryForObject(sql,new Object[]{groupName},Integer.class);
    }
    ...
    public Group createGroup(Integer groupBossId,String groupName){
        ...
        jdbcTemplateObject.update(sql, groupName, groupBossId);
    ...
    public Group createGroup(Integer groupBossId, String groupName ,String groupIcon){
        ...
        jdbcTemplateObject.update(sql,groupName,groupBossId,groupIcon);
    ...
    public void setNickName(Integer userId,Integer groupId,String nickName){ //设置组昵称
        ...
        jdbcTemplateObject.update(sql,nickName,userId,groupId);
    ...
    public void joinGroup(Integer userId,Integer groupId,String nickName){ //加入小组
        ...
        jdbcTemplateObject.update(sql,userId,groupId,nickName);
    ...
    public List<Group> getMyGroup(Integer userId){//获取我创建的组
        ...
        List<Group> mygroup = jdbcTemplateObject.query(sql,new Object[]{userId},new GroupMapper());
        return mygroup;
    }

    public List<Group> getUnderGroup(Integer userId){ //获取我从属的组(所有组)
        String sql ="select group_id from ods.user_group where user_id=?";
        List<Integer> groupIds = jdbcTemplateObject.queryForList(sql,Integer.class,userId);
    ...
    public Group getGroupByName(String groupName){ //由组名获取组
        String sql = "select * from ods.group where group_name =?";
        try {
            return jdbcTemplateObject.queryForObject(sql, new Object[]{groupName}, new GroupMapper());
    ...
    public String getNickName(int userId , int groupId){
        ...
        return jdbcTemplateObject.queryForObject(sql, new Object[]{userId, groupId}, String.class);
    }
    ...
    public Integer getBossId(int groupId){
        ...
        return jdbcTemplateObject.queryForObject(sql,new Object[]{groupId},Integer.class);
    }

    //获取组内成员
    public List<Integer> getMemberIds(int groupId){
        String sql = "select user_id from ods.user_group where group_id=?";
        List<Integer> userIds = jdbcTemplateObject.queryForList(sql,Integer.class,groupId);
        return userIds;
    }
}
